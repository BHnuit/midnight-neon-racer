...
先读 [PROJECT.md](PROJECT.md)、[CONTEXT.md](CONTEXT.md)、[docs/new-session.md](docs/new-session.md)、[TREE.md](TREE.md)。进入正式工程后再读 `../midnightroad/AGENTS.md` 与 `../midnightroad/docs/architecture.md`。
